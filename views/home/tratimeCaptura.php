                ...
                <div class="DatosCapTram">
                    ...
                    <div id="DivDictBasePsgs">
                        ...
                        <div id="DivBaseBaja"><!--<p>BASE Y BAJA</p> --><h4 id="tituto_BasJubBajFall" class="titulosDivs"></h4>
                            <div id="DivInputFechBase"><h5 id="tituto_InptBasJub"></h5><input type="date" id="fechBaseMae" name="fechBaseMae" min="1930-01-01" max="2050-12-31"  pattern="\d{4}-\d{2}-\d{2}"  ></div></br>   
                            <div id="DivInputFechBaja"><h4 id="tituto_InptBajFall"></h4><input type="date" id="fechBajaMae" name="fechBajaMae" min="2000-01-01" max="2050-12-31"  pattern="\d{4}-\d{2}-\d{2}"  ></div>
                        </div>
